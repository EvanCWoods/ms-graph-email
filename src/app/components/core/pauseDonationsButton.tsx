...
import pauseStripeSubscription from "~/app/server-actions/stripe/pauseStripeSubcription";
...
const PauseDonationButtons: React.FC<IProps> = ({ subscriptionId  }) => {
  ...
  const handlePauseDonations = async () => {
    // Logic to pause donations
    await pauseStripeSubscription(subscriptionId);
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="m-auto max-w-md rounded-lg bg-white p-4 shadow-lg">
            <p>Are you sure you want to pause your donations?</p>
